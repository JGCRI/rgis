...
test_that("Test zone fractions computation", {
  #Import the raster
  expect_warning(test_output <- grid_to_zone_fraction(poly_path = "test_data/shp/northcarolina_county_wgs84.shp",
                                                      ncdf_path = "test_data/nc/tas_watch_monthly_1991.nc4",out_csv = "tmp.csv"))
  test_output %>% 
    group_by(GEOID) %>% 
